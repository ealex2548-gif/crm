...
<div className="modal-actions"><button onClick={onClose}>Cancelar</button><button className="confirm" disabled={!text.trim()||saving} onClick={()=>submit(text.trim())}>{saving?"Salvando...":"Salvar nota"}</button></div>
</Modal>
}

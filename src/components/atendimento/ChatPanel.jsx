...
export function ChatPanel({active,mobile,setMobile,detailsOpen,setDetailsOpen,searchChat,setSearchChat,setPage,onNote,quickOpen,setQuickOpen,quickCat,setQuickCat,quick,messages,summaryOpen,setSummaryOpen,typing,draft,setDraft,onSend,audio,setAudio,onReply,onNewTicket,onFinish}){
...
<Composer draft={draft} setDraft={setDraft} onSend={onSend} audio={audio} setAudio={setAudio}/>
</section>
}

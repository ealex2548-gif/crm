...
export function ChatPanel({active,mobile,setMobile,detailsOpen,setDetailsOpen,searchChat,setSearchChat,setPage,ticketsPageTarget,onNote,quickOpen,setQuickOpen,quickCat,setQuickCat,quick,messages,draft,setDraft,onSend,onSendFile,audio,setAudio,onReply,onNewTicket,onFinish}){
